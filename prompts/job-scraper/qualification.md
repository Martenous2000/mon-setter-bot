...
2. **Nature réelle du besoin commercial exprimé** : que cherche vraiment l'entreprise à travers cette description ? Développement d'un nouveau marché, structuration d'une fonction commerciale inexistante, remplacement d'un départ, couverture géographique (ex. marché français/européen pour une entreprise étrangère) ? Cite les passages concrets de la description qui justifient ta lecture.
   ⚠️ Distingue explicitement une entreprise qui n'a **pas encore** de présence commerciale établie sur la zone visée (signal fort : véritable point d'entrée, la prestation freelance peut se substituer ou accélérer) d'une entreprise qui a **déjà** une organisation commerciale en place sur cette zone et recrute simplement pour la renforcer ou remplacer un départ (signal plus faible : c'est du staffing d'équipe existante, pas une ouverture de marché). Les résultats de la recherche décideur et de l'enrichissement entreprise (autres employés déjà en poste sur la zone, avec des intitulés similaires ou seniors) sont un indice direct de cette distinction : si plusieurs personnes de l'entreprise occupent déjà des rôles commerciaux seniors sur la même zone géographique que le poste, pondère le score à la baisse sur ce critère, même si le reste de l'offre semble pertinent.
