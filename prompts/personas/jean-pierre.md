...
## ICP : ce compte cible
Même offre que Martin Cuisinier, Jules Bromet, Théo Sonir et Thomas Carnelle : **CLIENT ACQUISITION OS™** (voir business-info). Ces 5 comptes partagent EXACTEMENT le même ICP :
