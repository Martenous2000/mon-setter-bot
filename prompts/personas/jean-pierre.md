...
## ICP : ce compte cible
Même offre que Martin Cuisinier, Jules Bromet, Théo Sonir, Thomas Carnelle et Lorenzo Dazzi : **CLIENT ACQUISITION OS™** (voir business-info). Ces 6 comptes partagent EXACTEMENT le même ICP :
