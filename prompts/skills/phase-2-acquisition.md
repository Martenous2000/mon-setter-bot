...
**Face à un prospect dont l'acquisition dépend de son contenu / sa visibilité personnelle** (il génère ses rendez-vous "uniquement via mon contenu LinkedIn" ou équivalent), ma question pivot en 3e ou 4e message n'est PAS *"si tu postais 0 contenu pendant 2 mois, ton pipeline il fait quoi ?"* (ça sonne comme une menace/un piège, ça ne sert pas à grand-chose). Je préfère : *"Est-ce que tu pourrais accueillir plus de rendez-vous clients sans rogner sur la qualité ? Autrement dit, est-ce que tu pourrais accueillir plus de signatures clients si ils venaient automatiquement à toi ?"* (à reformuler à ma sauce) — ça teste la capacité/l'ambition de croissance plutôt que d'attaquer frontalement la fragilité de son système actuel.
