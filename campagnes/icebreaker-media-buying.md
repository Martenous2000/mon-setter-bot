# Icebreaker Media Buying - 3 temps

## Contexte
Icebreaker en 3 messages successifs pour ouvrir la conversation avec des media buyers Meta Ads en vue d'un partenariat (echange setup IA contre campagne pub). A envoyer manuellement, un contact a la fois - PAS d'envoi automatise en boucle (risque de ban LinkedIn sur les comptes Martin/Keanu/Jules/Jean-Pierre).
...
## Exemple rempli (Florian Gros)

```
Salut Florian,

Je vois que tu es Media Buyer Meta Ads, tu as deja genere 1,2M€ pour tes clients, ca tombe bien parce que j'ai un deal qui pourrait t'interesser.
